        ...
        {connectionOptions && (
          <div className="mt-3 gap-2 align-items-center relative">
            ...
            >
              ...
              <p className="m-0 p-0 lg:inline-block md:hidden sm:hidden">
                Add Connection
              </p>
            </button>
            {dropdownOpen && (
...
const SelectedDocument = ({
  ...
  return (
    <div
      className={`flex flex-wrap rounded-xl bg-document_item_radient_blue_light dark:bg-document_item_radient_blue p-3 gap-3`}
    >
